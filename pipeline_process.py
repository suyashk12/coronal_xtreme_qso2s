...
rootdir = "/Users/thepoetoftwilight/Documents/SDSS/QSO-Test/"
...
if __name__ == "__main__":
    ...
    with Pool(processes = n_proc) as pool:
        pool.map(pipeline_func.process_obj, [(rootdir, obj, q) for obj in obj_list])
...
if __name__ == "__main__":
    ...
    with Pool(processes = n_proc) as pool:
        pool.map(pipeline_func.emission_pipeline, [(rootdir, obj, obj_data[obj], q, line_ids) for obj in obj_list])
...
df.to_csv(rootdir + "pipeline_emission_1.csv", index=False)
